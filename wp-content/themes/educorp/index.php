            ...
            if ($permitido || in_array('administrator', (array) $user->roles) || in_array('author', (array) $user->roles)) { ?>
               ...
               <div class="portfolio-description">
                  ...
                  <fieldset>
                     ...
                     <table class="carga">
                     <tr><td>Videoaula gravada</td><td><?php echo get_post_meta(get_the_ID(),'carga1',true); ?></td></tr>
                     <tr><td>Videos diversos</td><td><?php echo get_post_meta(get_the_ID(),'carga2',true); ?></td></tr>
                     <tr><td>Textos, artigos, capítulos de livros e similares</td><td><?php echo get_post_meta(get_the_ID(),'carga3',true); ?></td></tr>
                     <tr><td>Aulas síncronas ou presenciais</td><td><?php echo get_post_meta(get_the_ID(),'carga4',true); ?></td></tr>
                     <tr><td>Elaboração de projetos, mapeamentos de processos, TCCs e demais atividades práticas</td><td><?php echo get_post_meta(get_the_ID(),'carga5',true); ?></td></tr>
                     <tr><td><strong>TOTAL DA CARGA HORÁRIA DA CAPACITAÇÃO</strong></td><td><strong><?php echo get_post_meta(get_the_ID(),'cargatotal',true); ?></strong></td></tr>                                                          
                     </table>
                  </fieldset>
