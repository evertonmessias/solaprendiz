...
if($ehresp == 0){
  ...
  $mensagem = "<h3>curso Educorp:</h3>Responsável, a curso <strong>".$titulo."</strong> foi finalizada!";
  $quem = "ao Responsável";
}else if($ehresp == 1){
  $URL_ATUAL= "https://$_SERVER[HTTP_HOST]";
  $para = $_POST['emailconteudista'];
  $mensagem = "<h3>curso Educorp:</h3>Conteudista, você já pode editar a curso <a href='".$URL_ATUAL."' target='_blank'><strong>".$titulo."</strong></a>.";
