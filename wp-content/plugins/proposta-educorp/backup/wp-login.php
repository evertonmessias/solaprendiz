...
/* hover state */
#login input[type="checkbox"]:not(:disabled):hover {
    border-color:rgba(0,0,0,0.5);
    box-shadow:inset 1px 1px 0 #fff, 0 0 4px rgba(0,0,0,0.3);
}

/* active state */
#login input[type="checkbox"]:active:not(:disabled) {
...
#login input[type="checkbox"]:focus {
    outline:none;
    box-shadow: 0 0 1px 2px rgba(255, 38, 0, 0.938);
}

/* #login input checked border color */
...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	?>
	<div id="login">
		<a class="logoedu" href="/"><img src="/wp-content/themes/educorp/assets/img/educorp-logo-transp.png" title="Educorp" alt="Educorp"></a>
...
<script type="text/javascript">
			window.onload = function() {
				document.querySelector("h3.galogin-or").innerHTML = "ou";
