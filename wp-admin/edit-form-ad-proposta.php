...
<script>
	...
	/* ------- equipes da capacitação -------   */	
	
    function addatuacao(val,indice){ //select
		var arrayeq = document.querySelector("#equipe_atuacao_hidden .acf-input input").value.split(',');
		arrayeq[indice] = val;			
		document.querySelector("#equipe_atuacao_hidden .acf-input input").value = arrayeq;
    }
